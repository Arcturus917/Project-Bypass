...
if not coreGay:FindFirstChild(guiName) then
    ...
    print("â€¢   MrDodoMan bypass loaded.")
else
   
    print("â€¢   MrDodoMan bypass is already executed..")
    return
end
...
local function fadeTextThatMadeByChatGpt(labeltext)
    ...
    local fadeDuration = 1 -- Adjust to your preference

    -- Find or use TweenService
...
function focuslost(e)
        ...
        if TextChatService.ChatVersion == Enum.ChatVersion.LegacyChatService then
            ...
            modifyText(GXL["TextBox"].Text, "All")
        else
